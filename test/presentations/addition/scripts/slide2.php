...
mysql_query("UPDATE addition SET result='slide3' where sname='slide2'",$con);
...
header("Location:http://localhost/test/presentations/addition/slide1.php");
mysql_query("UPDATE addition SET result='slide1' where sname='slide2'",$con);
