...
<body>
				...
				<div class="header"> provide information here: </div>
...
?>
				...
				<li>title section<br>
					...
					<div class="nav"> Choose the decision element: </div><br />
					<select name="decision_name">
						<option value="radio button">radio button</option>
						<option value="check box">check box</option>
					</select>
					<br>
					<div class="nav"> Enter the number of decision elements needed in the slide:</div><br/>
					...
					<br />
					<br />
					<div class="nav"> Enter the label for the decision elements in order:</div>
					<br />
